...
#define devSigTimerCompare     TIMER0_COMP_vect
#define devSigTimerOverflow    TIMER0_OVF_vect
 ...
 */
  ...
  __do_clear_bss_loop:
    st   -X, r1
    cp   r26, r24
    cpc  r27, r1 /* hi8(devRAMbegin) assumed to be 0 */
  ...
  __do_copy_data:
    ...
    nop
    nop
  /* Catch the time interrupt here: 0x0013 */
    rjmp privTickYield
